...
class PaymentInitialize extends StatefulWidget {
  final Product product;
  PaymentInitialize(this.product);

  @override
  _PaymentInitializeState createState() => _PaymentInitializeState();
}

class _PaymentInitializeState extends State<PaymentInitialize> {
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () async {
                ...
                final _ = await checkOut(result.accessCode, result.reference,
                    paymentcontroller.amount);
                paymentcontroller.showSnackbar("Success", "Payment Successful");
